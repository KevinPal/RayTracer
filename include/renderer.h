...
__global__ void renderRaysKernel(Ray* rays, unsigned char* output, IntersectData* primaryIntersect, IntersectData* shadowIntersect, IntersectData* reflectIntersect, unsigned char* deviceReflectOutput, int width, int height, BVHNodeGPU* scene, Matrix44* transform, Matrix44* invTransform, char* textureMem, int textureWidth, int textureHeight);
